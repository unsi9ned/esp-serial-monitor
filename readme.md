...
![ESP Serial Monitor+](./img/esm_v020.PNG)
...
- Работает с прошивками, созданными в Arduino IDE, Sloeber, Espressif IDE, PlatformIO
...
- Позволяет пользователю принудительно изменить режим программирования
...
- Позволяет записать merged-bin (полный образ flash)
- Позволяет записать bin-файл в ручном режиме. Пользователь сам определяет смещение дампа в памяти
